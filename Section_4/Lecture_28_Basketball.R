...
# Lecture 27 Welcom to section and what you will learn.

# Analysing Basketball player stats for top 10 players in NBA
# To discover how well they have been playing,  when their stats drop
# and try to understand why.  See where they have had injuries or haven't
# been fielded.

# In this section learn about matrices - a way to reprsesnt data in R
# and will be a stepping stone to the next section on datafreames.

# Lecture 28- Project Brief:  Basketball Trends:

# Take top 10 highest paid players in the NBA in 2015-16 season and
# analyse how they have been playing over the last 10 years
# Task to find and analyse trends in their play deriving several
# metrics from basic datg provided by the NBA on their website.
